...
import ${basePackage}.core.ret.ServiceException;
...
//      ${modelNameLowerCamel}.setId(ApplicationUtils.getUUID());
    ...
    */
    ...
    public RetResult<PageInfo<${modelNameUpperCamel}>> list(@RequestParam(defaultValue = "0") Integer page,@RequestParam(defaultValue = "0") Integer size) throws Exception {
